...
## 修改记录：
-	OpenCore20200620-2300 BUG见正文。
-	。。。。。。。。。。。
-	OpenCore20200620-0900 通过使用仿冒的ssdt添加PS2k键盘解决键盘不能使用的问题。 
-	Opencore20200619-0937 只有PS2K键盘不能使用
-	OpenCore20200617-2449 不记得有什么问题了。
-	OpenCore20200617-2133 第一成功安装版本。
