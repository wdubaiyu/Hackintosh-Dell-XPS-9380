...
## 修改记录：
- OpenCore20211226-1233 升级OC73以及其他kext驱动，由于很久没有使用了，没跟上大部队后期看情况。

- OpenCore20211226-1223 移除SSDT-IRQ似乎没有什么用，修复键盘静音键不生效问题（输出设备：Platforms.xml  MuteInputAmp=fale;VolumeInputAmp=false）。
